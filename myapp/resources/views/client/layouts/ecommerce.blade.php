      ...
      <div class="row py-3 border-bottom">
        ...
        <div class="col-sm-6 offset-sm-2 offset-md-0 col-lg-5 d-none d-lg-block">
          <div class="search-bar d-flex align-items-center bg-light p-2 my-2 rounded-4">
            <form id="search-form" class="flex-grow-1 me-2" action="{{ route('client.products') }}" method="GET">
              @csrf
              <input type="text" name="search" class="form-control border-0 bg-transparent"
                placeholder="Tìm kiếm hơn 20.000 sản phẩm..." style="box-shadow:none; outline:none;"
        ...
        <div class="col-sm-8 col-lg-4 d-flex justify-content-end align-items-center gap-3 mt-3 mt-sm-0">
          <ul class="d-flex list-unstyled m-0 gap-3 align-items-center">

            <!-- 1. Icon Người -->
            <li>
              @if(session('user_id'))
                <a href="{{ route('account') }}" class="icon-btn" title="Thông tin tài khoản">
            ...
            <!-- 2. Icon Giỏ hàng + Số lượng sản phẩm -->
            <li class="position-relative">
              <a href="{{ route('client.cart') }}" class="icon-btn" title="Giỏ hàng">
                <svg width="26" height="26" viewBox="0 0 24 24">
                  <use xlink:href="#cart"></use>
                </svg>
                <span id="cart-count"
                  class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger"
                  style="font-size: 10px; display: {{ ($cartCount ?? 0) > 0 ? 'block' : 'none' }};">
                  {{ $cartCount ?? 0 }}
                </span>
              </a>
            </li>
            ...
            <!-- Mobile: Search Icon -->
            <li class="d-lg-none">
              <a href="#" class="icon-btn" data-bs-toggle="offcanvas" data-bs-target="#offcanvasSearch">
