        ...
        <div class="col-lg-5">
            <div class="product-gallery">
                <div class="main-image mb-3">
                    <img 
                        src="{{ $productVariant->image ? asset('storage/products/' . $productVariant->image) : asset('images/no-image.jpg') }}"
            ...
            <div class="product-info">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb small">
                        ...
                        <li class="breadcrumb-item active">{{ $productVariant->product->category->name ?? 'Chưa phân loại' }}</li>
                    </ol>
                </nav>
                ...
                <div class="d-flex gap-3 mb-4">
                    {{-- <form action="{{ route('cart.add', $productVariant->id) }}" method="POST" class="flex-fill"> --}}
                        ...
                        <div class="col">
                            <div class="product-item">                                
                                ...
                                <h3 class="card-title mb-1">
                                    <a href="{{ route('client.productDetail', ['id' => $variant->id]) }}" class="product-title text-dark text-decoration-none">
