            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    ...
                    <form method="GET" action="{{ route('client.products') }}" id="filter-form">
                        ...
                        <a href="{{ route('client.products') }}" class="btn btn-outline-secondary w-100 mt-2">Xóa lọc</a>
                        <a href="{{ route('client.home') }}" class="btn btn-outline-secondary w-100 mt-2">Về trang chủ</a>
                    </form>
                </div>
            </div>
        </div>
                    ...
                    @foreach($productVariants as $productVariant)
                        <div class="col">
                            <div class="product-item">
                                ...
                                {{-- hình ảnh --}}
                                <figure>
                                    <a href="{{ route('client.productDetail', ['id' => $productVariant->id]) }}" title="Product Title">
                                ...
                                <h3 class="card-title mb-1">
                                    <a href="{{ route('client.productDetail', ['id' => $productVariant->id]) }}" class="product-title text-dark text-decoration-none">
